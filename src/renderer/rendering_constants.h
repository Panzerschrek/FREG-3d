...
#ifdef OGL21
#define AMBIENT_SKY_DAY_LIGHT 0.1f * 0.0625f
#define AMBIENT_SKY_NIGHT_LIGHT 0.012f * 0.0625f
#define AMBIENT_FIRE_LIGHT 0.16f
#else//if OGL3.3
#define AMBIENT_SKY_DAY_LIGHT 0.5f * 0.0625f
#define AMBIENT_SKY_NIGHT_LIGHT 0.001f * 0.0625f
...
#define WATER_ALBEDO m_Vec3( 72.0/255.0f, 108.0/255.0, 169.0/255.0 )
#define UNDERWATER_FOG_COLOR m_Vec3( 43.0/255.0, 82.0/255.0, 198.0/255.0 )
